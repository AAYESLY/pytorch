...
void TensorImpl::set_sizes_and_strides(
  ...
  // extra_meta_ may already exist for an unrelated reason (e.g. a functional
  // wrapper carrying metadata), so check symbolic_shape_meta_ independently
  // rather than gating creation on extra_meta_ being null.
