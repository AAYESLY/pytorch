...
class ForeachTestsAccelerator(TestCase):
    ...
    def test_foreach_cpp_wrapper_cuda(self, device=GPU_TYPE):
        self._test_single_list(op=torch._foreach_add, device=device)
    ...
    def test_enable_dynamic_shapes_cpp_wrapper_cuda(
        self, device=GPU_TYPE, op=torch._foreach_add
    ):
        def fn(a0, a1, b0, b1):
            return op([a0, a1], [b0, b1])
